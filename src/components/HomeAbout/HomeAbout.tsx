        ...
        <div className=' bg-white flex justify-center  mt-48 space-x-20 mx-20'>
          <div className='w-2/5 bg-white font-roboto'>
            <h1 className='text-5xl font-semibold'>
              Fullstack web developer - Alexis Mattaruco
            </h1>
            <br />
            <br />
            <div className='font-sans text-base text-gray-400'>
              ...
              <br />
              <div className="text-2xl text-gray-500 pr-5">
          ...
          >
            <img
              src={aboutImage}
              alt='About image'
              className='object-cover w-full h-full absolute inset-0 rounded-3xl opacity-70 grayscale'
            />
          </div>
        </div>
      </div>
